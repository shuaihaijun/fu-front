...
window.alert = function(msg, callback) {
  ...
  div.innerHTML = '<style type=\'text/css\'>' +
    ...
    '.nbaDialog { position: fixed; z-index: 5000; width: 80%; max-width: 300px; top: 50%; left: 50%; -webkit-transform: translate(-50%, -50%); transform: translate(-50%, -50%); background-color: #2b3348; text-align: center; border: 2px solid #409EFF; border-radius: 8px; overflow: hidden; opacity: 1; color: white; }' +
    '.nbaDialog .nbaDialogHd { padding: .2rem .27rem .08rem .27rem; }' +
  '.nbaDialog .nbaDialogHd .nbaDialogTitle { font-size: 17px; font-weight: 400; }' +
  '.nbaDialog .nbaDialogBd { padding: 0 .27rem; font-size: 15px; font-weight: bold; line-height: 1.3; word-wrap: break-word; word-break: break-all; color: #e6e6e6; margin: 10px auto}' +
