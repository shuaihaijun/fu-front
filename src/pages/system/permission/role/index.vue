<template>
  <div>
    ...
    <os-table  :selection="true" :searchHeight="queryFormHeight" :operate="true" :columnData="columnData" :tableData="tableData" @change-selection="selectionChange" @click-operate="handleOperate">
      <div slot="r">
        <el-button @click="roleAdd()"><i class="el-icon-edit-outline"></i> 新增</el-button>
        <el-button @click="roleEdit()"><i class="el-icon"></i> 编辑</el-button>
        <el-button @click="roleDelete()"><i class="el-icon"></i> 删除</el-button>
      </div>
    </os-table>
