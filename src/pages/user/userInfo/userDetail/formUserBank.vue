<template>
    <div>
      ...
      <el-col :span="5">
        <el-form-item label="户主名称:" prop="hostName">
          <el-input v-model="dataForm.hostName" :disabled="disabled"></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="7">
        <el-form-item label="银行卡号:" prop="code">
          <el-input v-model.number="dataForm.code" :disabled="disabled"></el-input>
        </el-form-item>
      </el-col>
    </div>
</template>
